...
void loop()
{
    ...
    if(currentMillis - previousMillis > interval) {
        ...
        // retrieve pressure, temperature and standard atmospheric pressure
...
void sendData(float temperature, long pressure) 
{
  if(!client.connected())
  {
    if (client.connect(server, 3000)) {
      ...
      client.print("GET /send_barom_data/");
      client.print(pressure);
      client.print("/");      
      client.print(temperature);      
      client.println(" HTTP/1.1");
      client.println("Host: www.simplicity.be");
